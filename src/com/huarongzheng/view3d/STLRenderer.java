...
//		 gl.glBlendFunc(GL10.GL_ONE, GL10.GL_SRC_COLOR);
		...
		gl.glLightModelfv(GL10.GL_LIGHT_MODEL_AMBIENT, getFloatBufferFromArray(new  float[]{0.5f,0.5f,0.5f,1.0f}));// 鍏ㄥ眬鐜鍏�
	...
	/**
	 * 璋冩暣Z杞村钩绉讳綅缃�    锛堢洰鐨勫紡涓轰簡妯″瀷灞曠ず澶у皬閫備腑锛�
	 */
